...
resdir=results/supervised/imagenet/transfer/le_finetune/${final_data}_${final_wd}/${final_model}_synt5
mkdir ${resdir} -p
...
--arch ${final_model} --lr 0.015 --scheduler_type cosine --final_lr 0.0000001 --epoch 48 \
--pretrained results/supervised/imagenet/resnet50_synt5/checkpoint270.pth.tar  \
--headpretrained results/supervised/imagenet/transfer/lineareval_seer/inaturalist18_${final_wd}/resnet50_synt5/checkpoint.pth.tar \
...
--headinit dumped_weights --classifier_bn2nonbn True --use_bn True  --eval_freq 1 --sync_bn True  || scontrol requeue $SLURM_JOB_ID
